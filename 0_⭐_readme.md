...
### 1- Designing an API Platform for a SaaS Product

This is the document that brings together all concepts covered in this repository.

👉 **[6_⭐_saas-api-platform-design](https://github.com/hayatiokur/api-systems-playbook/blob/main/6_⭐_saas-api-platform-design.md)**

### 2- Smart API assistant

Check out the AI tool I created!

👉 **[8_⭐_smart-api-assistant/readme](https://github.com/hayatiokur/api-systems-playbook/blob/main/8_⭐_smart-api-assistant/readme.md)**
